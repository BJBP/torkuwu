    ...
    <form id="msform">
        ...
        <?php
            ...
            while($OpcionFila = $listaOpciones->fetch(PDO::FETCH_ASSOC))
            {
                ...
                echo '<div class="col col-lg-6 mt-4 text-center">
                    <img src="data:image/png;base64, '.base64_encode($OpcionFila['imagen']).'" class="img-fluid" style="width: 100px;" alt="metas">
                    <h3 style="color:#00293A; font-size:25px;"><b><br>'.$OpcionFila['NombreOpcion'].'</b></h3>
                    <p style="color:#7D7D7D; text-align: center; font-size: 16px;">'.$OpcionFila['descripcion'].'</p>              
                </div>';
...
<script src="http://thecodeplayer.com/uploads/js/jquery.easing.min.js" type="text/javascript"></script>
    ...
    <script src="./assets/js/form 2.js?v=4"></script>
</body>
