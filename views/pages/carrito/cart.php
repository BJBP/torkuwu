...
<html lang="en">
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Proceder a compra</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      var cantidad= $(this).val(); var id= $(this).data('id');
      ...
      function incrementar (cantidad, precio, id){ var mult = parseFloat(cantidad)* parseFloat(precio); 
        $(".cant"+id).text("$"+mult);
      $.ajax({
      method: 'POST', url:"./php/actualizar.php", 
      data: {
      id:id,
      cantidad: cantidad
      }
