      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md-9 order-2">
            ...
            // for($i=0;$i<50;$i++){ $conexion->query("insert into productos (nombre, descripcion, precio, imagen, inventario, id_categoria, talla, color) values ( 'Producto $i', 'Esta es la descripcion',".rand(10,1000).", 'cloth_1.jpg',".rand(1,100).",1,'XL', 'Blue' )") or die($conexion->error);}
