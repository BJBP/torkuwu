...
<div class="container" id="product-cards">
    <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card">
                <img src="./assets/image/P03.png" width="250px" height="260px" alt="">
                <div class="card-body">
                    <h3>Smart Watch</h3>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <div class="star">
    ...
    <div class="row" style="margin-top: 30px;">
        <div class="col-md-3 py-3 py-md-0">
            <div class="card">
                <img src="./assets/image/p16.png" alt="">
                <div class="card-body">
                    <h3>Hand Bag</h3>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <div class="star">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card">
                <img src="./assets/image/p19.png" alt="">
                <div class="card-body">
                    <h3>Sport Shoes</h3>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <div class="star">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card">
                <img src="./assets/image/p20.png" alt="">
                <div class="card-body">
                    <h3>Girls Heel</h3>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <div class="star">
    ...
    <div class="row" style="margin-top: 30px;">
        <div class="col-md-3 py-3 py-md-0">
            <div class="card">
                <img src="./assets/image/p9.jpg" alt="">
                <div class="card-body">
                    <h3>Dark Pant</h3>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <div class="star">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card">
                <img src="./assets/image/image8.jpeg" width="250px" height="296px" alt="">
                <div class="card-body">
                    <h3>Mwalk Billies</h3>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <div class="star">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card">
                <img src="./assets/image/p11.jpg" alt="">
                <div class="card-body">
                    <h3>Sweet Shirt</h3>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <div class="star">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card">
                <img src="./assets/image/p12.jpg" alt="">
                <div class="card-body">
                    <h3>Black T-Shirt</h3>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <div class="star">
